...
<div class="wrap yog-wrap">
	...
	<div class="yog-dashboard">
		...
		<h2 class="h1 yog-align-center"><?php echo esc_html__( 'YOGThemes Plugins', 'engines' ); ?></h2>

       <div class="yog-info yog-align-center bg-seashell">
          <h4><i class="fa fa-check text-gradient"></i> <?php echo esc_html__( 'Custom and third party plugins ( over $1000 in value ) you can use for free!', 'engines' ); ?></h4>
       </div>
				...
				<li class="yog-card yog-card-is-<?php echo esc_attr( $status ); ?>">
					...
					<div class="yog-card-inner">
						...
						<div class="yog-icon-container">
							...
							<!-- <img src="<?php echo esc_url( $plugin['yog_logo'] );  ?>" alt="Extension" class="icon"> -->
