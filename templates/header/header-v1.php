<?php if( yog_helper()->get_option(  'engines-header-top', 'raw', true, 'options' ) ): ?>
    <div class="header">
            ...
            <div class="row">
                ...
                <div class="col-md-11 col-sm-11 col-xs-12">
                    ...
                    <?php if( $yog_schedule = yog_helper()->get_option(  'engines-header-schedule', 'raw', false, 'options' ) ): ?>
                        <div class="header-contact header-twow clearfix">
                            <p><!--i class="flaticon-technology alignleft"></i--> <?php echo wp_kses( $yog_schedule, array( 'br' => array() ) ); ?></p>
                        </div><!-- end header-contact -->
                    <?php endif; ?>
                    <?php if( $yog_number = yog_helper()->get_option(  'engines-header-number-v1', 'raw', false , 'options') ): ?>
                        <div class="header-contact header-threew clearfix" style="width: 42%; border-left: 1px solid #00559e;">
            ...
            <?php 
                ...
                echo '<div id="navbar" class="navbar-collapse collapse">';
                    ...
                    echo '<ul class="nav navbar-nav navbar-right">';
                        ...
                        // хотел в меню добавить фильтром то что в сессии                    
                        echo '<li class="navbar-cart"><a href="'.esc_url( home_url( '/' )).'корзина">КОРЗИНА <i class="fa fa-shopping-cart"></i> <small>'.count($_SESSION['mycart']).'</small></a><div class="cart_vis">'.apply_filters( 'get_cart_menu', $_SESSION['mycart'] ).'</div></li>';
                        
                       //Cart woocomerce
                        if( yog_helper()->get_option( 'engines-header-menu-cart', 'raw', false, 'options' ) && in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ):
                    ?>
