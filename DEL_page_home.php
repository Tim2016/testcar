...
<?php echo do_shortcode('[get_top_slider id_carousel="mytopslider" speed_carousel="12000" category="20" per_page="10"]'); ?>        
...
<div class="container box-product">
    ...
    <div class="row">
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a1.jpg" alt="" class="img-responsive"><div><span>Бортовые автомобили</span></div></a></div>
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a2.jpg" alt="" class="img-responsive"><div><span>Самосвалы</span></div></a></div>
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a3.jpg" alt="" class="img-responsive"><div><span>Седельные тягачи</span></div></a></div>
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a4.jpg" alt="" class="img-responsive"><div><span>Спецтехника</span></div></a></div>
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a5.jpg" alt="" class="img-responsive"><div><span>Шасси</span></div></a></div>
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a6.jpg" alt="" class="img-responsive"><div><span>Прицепная техника</span></div></a></div>
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a7.jpg" alt="" class="img-responsive"><div><span>Автобусы</span></div></a></div>
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a8.jpg" alt="" class="img-responsive"><div><span>Автомобили с пробегом</span></div></a></div>
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a9.jpg" alt="" class="img-responsive"><div><span>Опции</span></div></a></div>  
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a10.jpg" alt="" class="img-responsive"><div><span>Сервисный центр</span></div></a></div>  
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a11.jpg" alt="" class="img-responsive"><div><span>Оригинальные запчасти</span></div></a></div>  
        <div class="col-md-4"><a href=""><img src="<?php echo $site_host ?>/wp-content/themes/engines/img/box-product/a10.jpg" alt="" class="img-responsive"><div><span>Сервисный центр</span></div></a></div>  
    </div>
</div>
...
<div class="container box-sales-leader">    
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <!-- 25,28,29,30 -->
            <?php echo do_shortcode('[get_sitebar_three id_carousel="myThree" speed_carousel="3000" category="18" per_page="20"]'); ?>
        </div>
...
<div class="container box-about">
    ...
    <div class="row">
        ...
        <div class="col-md-6">            
            <!-- 26 -->
            <p><?php echo do_shortcode('[get_sitebar_gallery id_carousel="myGallery" speed_carousel="9000" category="17" per_page="10"]'); ?></p>
        </div>
    </div>
</div>
...
<div class="container box-news">
    ...
    <div class="row">
        <?php echo do_shortcode('[get_box_news category="32" per_page="3"]'); ?>        
...
<div class="container box-news">
    ...
    <div class="row">    
        <?php echo do_shortcode('[get_box_news category="33" per_page="3"]'); ?>
        <div class="col-md-12 text-center">                
