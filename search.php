 ...
 */
 ...
 get_header(); 
    ...
    //Search Layout.  
    $yog_sidebar  = yog_helper()->get_option( 'blog-search-enable-globa', 'raw', true, 'options' );  
            ...
            <div class="row">
                <?php if( 'left' == $yog_layout && ( isset( $yog_sidebar ) && !empty( $yog_sidebar ) ) ){ ?>
                    <div class="custom-sidebar col-md-3 col-sm-12">
                        <?php 
                            if( is_dynamic_sidebar( yog_helper()->get_option( 'search-sidebar', 'raw', 'primary', 'options' ) ) ):
