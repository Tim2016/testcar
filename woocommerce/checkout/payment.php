...
?>
<div id="payment" class="woocommerce-checkout-payment payment-method col-lg-6 col-md-6 col-sm-12 col-xs-12 payment_system">
    <h3><?php echo esc_html__( 'PAYMENT METHOD', 'woocommerce' ); ?></h3>
    <?php if ( WC()->cart->needs_payment() ) : ?>
		<div class="wc_payment_methods payment_methods">
			<?php
